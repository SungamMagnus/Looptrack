...
export function createLoopView () {
  ...
  label.style.cssText = 'position:absolute;top:50%;transform:translateY(-50%);left:6px;font:700 9px var(--font-panel);letter-spacing:.08em;color:rgba(255,255,255,0.9);';
